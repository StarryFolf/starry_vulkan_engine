...
use vulkano::{command_buffer::{PrimaryAutoCommandBuffer, allocator::StandardCommandBufferAllocator, RenderPassBeginInfo, SubpassContents, CommandBufferUsage, AutoCommandBufferBuilder}, render_pass::Framebuffer, pipeline::{GraphicsPipeline, graphics::viewport::Viewport, Pipeline}};
            ...
            .begin_render_pass(
                RenderPassBeginInfo {
                    ...
                    ..RenderPassBeginInfo::framebuffer(
                        frame_buffers[image_index as usize].clone(),
                    )
                }, 
